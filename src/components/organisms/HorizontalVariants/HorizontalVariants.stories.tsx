...
const meta = {
  title: 'Design System/Organisms/HorizontalVariants',
  component: HorizontalVariants,
  args: {
    variants,
    selectedVariantId: '',
    open: true,
...
} satisfies Meta<typeof HorizontalVariants>
 ...
 * first (always-visible) card fires `onVariantSelect` and checks it, and `Escape` dismisses the panel.
 */
