export const lightTheme = {
  ...
  '--alert-message-error-background': '#e4b6c3',
  '--alert-message-warning-background': '#FFF9E8',
  '--alert-message-information-background': '#3D5B49',
  '--alert-message-icon-error-background': '#CD8AA2',
  '--alert-message-icon-warning-background': '#fadbb0',
  '--alert-message-icon-information-background': '#708E7C',
  ...
  '--cta-secondary-default-opacity': 'rgba(255, 255, 0, 0.8)',
