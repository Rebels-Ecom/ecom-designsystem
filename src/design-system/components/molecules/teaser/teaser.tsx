...
const Teaser = ({heading, preamble, text, image, imagePosition, tag, tagPosition, linkButton, fullWidth}: ITeaser) => {
    return(
        <div className={`${styles.teaser} ${imagePosition==='left' ? styles.teaserLeft : styles.teaserRight}`}>
            <div className={styles.imageWrapper}>
                ...
                {tag && <Tag {...tag} className={`${styles.tag} ${tagPosition==='left' ? styles.tagLeft : styles.tagRight}`}></Tag>}
            </div>
