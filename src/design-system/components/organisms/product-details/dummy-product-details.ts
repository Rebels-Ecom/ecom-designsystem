...
const dummyProductWineDetails = {
    ...
    "VisibleInfo": {
        "Specifications": [
            ...
            {
                "Item1": "Doft",
                "Item2": "Härlig fruktig ton med inslag av mogna plommon och körsbär."
            }
        ],
        "FullDescription": "Generöst, med fruktiga toner av fatvanilj, plommon, körsbär och hallon."
    },
    "InvisibleInfo": {
        "Specifications": [
            {
                "Item1": "Druvor",
                "Item2": "Ull de Llebre(Tempranillo) 42%, Cabernet Sauvignon 21%, Merlot 16%, Syrah 13%, Cariñena 8%"
            },
            {
                "Item1": "Ekfat",
                "Item2": "Tydlig Ekkaraktär"
            },
            {
                "Item1": "Fyllighet",
                "Item2": "07"
            ...
            {
                "Item1": "Druvor",
                "Item2": "Cabernet Sauvignon, Merlot, Syrah, Tempranillo"
            },
            {
                "Item1": "Ursprungsland",
                "Item2": "Spanien"
            ...
            {
                "Item1": "Ursprungsdistrikt",
                "Item2": "DO Costers del Segre"
            },
            {
                "Item1": "Ursprungsregion",
                "Item2": "Katalonien"
            },
            {
                "Item1": "Passar till ny",
                "Item2": "Vilt"
            },
            {
                "Item1": "Producent",
            ...
            {
                "Item1": "Vinifiering",
                "Item2": "Druvorna skördas för hand och kyls ner och läggs på ett sorteringsbord, där man sorterar bort oönskade druvor för hand. Sedan krossas de och ligger svalt på tank innan jäsningen startas och fortgår vid 22°C. Malolaktisk jäsning sker till 80% på tank och resten på ekfat. Vinet lagras på ny fransk ek i nio månader. - Innehåller sulfiter."
            },
            {
                "Item1": "Förpackning",
                "Item2": "Engångsglas"
            ...
            {
                "Item1": "Passar till",
                "Item2": "Kraftigare rätter av mörkt kött, gärna vilt, med smakrika tillbehör."
            },
            {
                "Item1": "PackagePerPallet",
                "Item2": "100"
...
export { dummyProductBeerDetails, dummyProductWineDetails }