import{c as r}from"./index-09749a66.js";import{j as c}from"./jsx-runtime-03333307.js";const o="_defaultStyling_1mqpp_1",t="_error_1mqpp_21",e={defaultStyling:o,"icon-small":"_icon-small_1mqpp_11","icon-medium":"_icon-medium_1mqpp_13","icon-large":"_icon-large_1mqpp_15","icon-xlarge":"_icon-xlarge_1mqpp_17",error:t},m=({icon:i,size:n,className:a,color:l})=>c.jsx("span",{className:r("icomoon",i,a||e.defaultStyling,{[e[`icon-${n}`]]:!!n,[e[l??""]]:!!l})});m.__docgenInfo={description:"",methods:[],displayName:"Icon",props:{icon:{required:!0,tsType:{name:"union",raw:`| 'icon-alert-circle'\r
| 'icon-bell'\r
| 'icon-arrow-right'\r
| 'icon-mail'\r
| 'icon-map-pin'\r
