import{r as m,j as r}from"./jsx-runtime-03333307.js";import{I as R}from"./input-field-1568a958.js";import{c as f}from"./index-09749a66.js";import{m as A}from"./motion-9380e2c6.js";import{I as L}from"./icon-cf6ebd85.js";import{H as k}from"./heading-ba18f9a9.js";import{T as M}from"./text-002528fe.js";import{B as x}from"./button-8e3f9b10.js";import{F as v}from"./flex-container-7aff6506.js";import{E as N}from"./expandable-wrapper-ef692179.js";import{L as B}from"./link-button-90dc87e9.js";const F=(n,s)=>{switch(n){case"email":return s&&H(s);case"password":return s&&V(s);case"age-verification":return s&&Number(s)>19;default:return!0}},S=n=>n.required?n.pattern?!!F(n.pattern,n.value??n.originalValue)&&!!(n.value??n.originalValue):!!(n.value??n.originalValue):n.pattern?!!F(n.pattern,n.value??n.originalValue):!0,H=n=>n&&/^[\w-\.]+@([\w-]+\.)+[\w-]{2,}$/.test(n),V=n=>n&&n!=="",W="_form_1538v_1",$="_formDirectionRow_1538v_6",z="_formTitle_1538v_11",U="_fieldsWrapper_1538v_15",P="_fieldsContainer_1538v_20",J="_field_1538v_15",O="_half_1538v_33",X="_full_1538v_37",G="_fieldDirectionRow_1538v_41",K="_actionsWrapper_1538v_47",Q="_link_1538v_56",Y="_linkDisabled_1538v_57",Z="_generalErrorMessage_1538v_68",ee="_generalErrorMessageDisabled_1538v_74",ne="_loaderContainer_1538v_84",re="_successIcon_1538v_95",t={form:W,formDirectionRow:$,formTitle:z,fieldsWrapper:U,fieldsContainer:P,field:J,half:O,full:X,fieldDirectionRow:G,actionsWrapper:K,link:Q,linkDisabled:Y,generalErrorMessage:Z,generalErrorMessageDisabled:ee,loaderContainer:ne,successIcon:re},ae=({onSubmit:n,onControlledSubmit:s,formTitle:g,formSubtitle:y,loading:d,responseMessage:c,...a})=>{var T,_;const[u,b]=m.useState(a.fields),[j,q]=m.useState(!1),w=m.useRef(null);m.useEffect(()=>{if(!w.current)return;const e=!u.some(i=>i.required&&!i.valid);q(e)},[u]);const E=m.useCallback(e=>{e.preventDefault(),n==null||n(u),s==null||s(e)},[u,n]),I=m.useCallback((e,i)=>{u.find(l=>l.name===i)&&b(l=>l.map(o=>{if(o.name===i){if(o.alphaField){const h=l.find(D=>D.name===o.alphaField);return{...o,dirty:!0,valid:(h==null?void 0:h.value)===e,value:e}}return{...o,dirty:!0,valid:S({...o,value:e}),value:e}}else return o.alphaField?{...o,dirty:o.dirty,valid:o.value===e,value:o.name===i?e:o.value}:o}))},[]),C=e=>{b(i=>i.map(l=>l.name===e?{...l,valid:!0}:l))};return c?r.jsx(A.div,{initial:{opacity:0,scale:.2},animate:{opacity:c?1:0,scale:c?1:.2},children:r.jsxs("div",{className:t.loaderContainer,children:[c.icon&&r.jsx(L,{icon:c.icon,className:t.successIcon}),c.title&&r.jsx(k,{order:3,noMargin:!0,children:c.title}),r.jsx(M,{align:"center",children:c.message}),c.onClose&&r.jsx(x,{type:"button",surface:"primary",onClick:c.onClose,children:c.closeLabel??"Stäng"})]})}):r.jsxs("form",{ref:w,className:f(t.form,a.alignSubmitButtonHorizontally?t.formDirectionRow:""),onSubmit:E,autoComplete:"on",children:[r.jsxs("div",{className:t.fieldsWrapper,children:[g&&r.jsx(k,{order:3,className:t.formTitle,children:g}),y&&r.jsx("p",{className:t.formSubtitle,children:y}),r.jsx(v,{wrap:!0,className:t.fieldsContainer,children:u==null?void 0:u.map((e,i)=>r.jsx("div",{className:f(t.field,a.alignSubmitButtonHorizontally?t.fieldDirectionRow:"",t[e.size??"half"]),children:e.fieldType==="input"&&r.jsx(R,{...e,value:e.value??e.originalValue,onChange:(p,l)=>{I(p,l)},onControlledChange:p=>{var l;(l=e.onControlledChange)==null||l.call(e,p)},focusOnRender:i===0,readonly:e.blocked,disabled:d,validateAutofill:a.isLogin?C:void 0})},e.name))}),r.jsx(N,{open:!!a.generalErrorMessage,children:r.jsx(v,{alignItems:"center",justifyContent:"center",children:a.generalErrorMessage&&r.jsx("p",{className:f(t.generalErrorMessage,{[t.generalErrorMessageDisabled]:d}),dangerouslySetInnerHTML:{__html:a.generalErrorMessage}})})})]}),a.captcha&&r.jsx(v,{justifyContent:"center",alignItems:"center",children:a.captcha}),(a.actions||a.linkActions)&&r.jsxs(v,{justifyContent:a.alignActions??"center",className:t.actionsWrapper,children:[(T=a.actions)==null?void 0:T.map((e,i)=>r.jsx(x,{...e,disabled:e.type==="submit"?!j||e.disabled:e.disabled||d,loading:e.type==="submit"&&d},`${e.type}-${i}`)),(_=a.linkActions)==null?void 0:_.map((e,i)=>r.jsx(B,{...e},`${e.id??"0"}-${i}`))]}),a.links&&r.jsx(v,{alignItems:a.alignActions??"center",flexDirection:"column",children:a.links.map((e,i)=>r.jsx("a",{className:f(t.link,{[t.linkDisabled]:d}),href:e.href,target:"_blank",children:e.name},`${e.name}-${i}`))})]})};ae.__docgenInfo={description:"",methods:[],displayName:"Form",props:{formTitle:{required:!0,tsType:{name:"string"},description:"descriptive title to display on top of form"},formSubtitle:{required:!1,tsType:{name:"string"},description:"descriptive subtitle to display under formTitle"},onSubmit:{required:!1,tsType:{name:"signature",type:"function",raw:"(data: TFormFieldType[]) => void",signature:{arguments:[{type:{name:"Array",elements:[{name:"intersection",raw:`{
