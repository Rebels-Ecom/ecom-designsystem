import{S as s}from"./social-media-link-c11e1c8e.js";import{j as a}from"./jsx-runtime-03333307.js";import{SocialMediaLinkStoryFacebook as m,SocialMediaLinkStoryInstagram as u,SocialMediaLinkStoryLinkedin as v}from"./social-media-link.stories-d313c5ed.js";import"./link-button-8ad71205.js";import"./index-09749a66.js";import"./ui-link-94ae867e.js";import"./icon-e3522fc5.js";const d="_socialMediaLinksList_1s86l_1",h={socialMediaLinksList:d},i=({socialMediaLinks:e})=>!Array.isArray(e)||!e.length?null:a.jsx("ul",{className:h.socialMediaLinksList,children:e.map((r,t)=>a.jsx(s,{...r},`${r.title}-${t}`))});i.__docgenInfo={description:"",methods:[],displayName:"SocialMediaLinks",props:{socialMediaLinks:{required:!0,tsType:{name:"Array",elements:[{name:"intersection",raw:`{
    icon: TIcon
} & ILink`,elements:[{name:"signature",type:"object",raw:`{
    icon: TIcon
}`,signature:{properties:[{key:"icon",value:{name:"union",raw:`| 'icon-alert-circle'\r
| 'icon-bell'\r
| 'icon-arrow-right'\r
| 'icon-mail'\r
| 'icon-map-pin'\r
...
}`,...(c=(o=n.parameters)==null?void 0:o.docs)==null?void 0:c.source}}};const x=["SocialMediaStory"];export{n as SocialMediaStory,x as __namedExportsOrder,w as default};
