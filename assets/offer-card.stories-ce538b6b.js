import{I as h}from"./icon-cf6ebd85.js";import{j as a}from"./jsx-runtime-03333307.js";const f="_offerCard_i8epn_1",g="_icon_i8epn_28",y="_heading_i8epn_33",i={offerCard:f,icon:g,heading:y},l=({icon:r,heading:p,richText:o})=>a.jsxs("div",{className:i.offerCard,children:[a.jsx(h,{icon:r,className:i.icon}),a.jsx("h4",{className:i.heading,children:p}),o&&o]});l.__docgenInfo={description:"",methods:[],displayName:"OfferCard",props:{icon:{required:!0,tsType:{name:"union",raw:`| 'icon-alert-circle'\r
| 'icon-bell'\r
| 'icon-arrow-right'\r
| 'icon-mail'\r
| 'icon-map-pin'\r
...
}`,...(s=(t=e.parameters)==null?void 0:t.docs)==null?void 0:s.source}}};var m,u,d;n.parameters={...n.parameters,docs:{...(m=n.parameters)==null?void 0:m.docs,source:{originalSource:`{
  ...OfferCardStoryTemplate,
  args: {
    icon: 'icon-mail',
...
}`,...(d=(u=n.parameters)==null?void 0:u.docs)==null?void 0:d.source}}};const w=["OfferCardStory1","OfferCardStory2"],S=Object.freeze(Object.defineProperty({__proto__:null,OfferCardStory1:e,OfferCardStory2:n,__namedExportsOrder:w,default:x},Symbol.toStringTag,{value:"Module"}));export{l as O,e as a,n as b,S as o};
