import{r as m,j as a}from"./jsx-runtime-03333307.js";import{F as z,v as I}from"./form-a5c130a5.js";import{l as i}from"./Spendrups_logo_horizontal-038b757f.js";const J="_loginForm_n3mi9_1",U="_logoWrapper_n3mi9_15",W="_logo_n3mi9_15",A="_closeButton_n3mi9_44",D="_overlay_n3mi9_53",p={loginForm:J,logoWrapper:U,logo:W,closeButton:A,overlay:D},l=({title:e,description:L,usernameLabel:v,username:S,passwordLabel:w,password:_,forgotPassword:t,onSubmit:T,offerLink:o,errorMessage:k,usernameError:F,passwordError:q,onPasswordChange:x,onUsernameChange:j,loading:C,logo:d,responseMessage:M,captcha:E,actions:B,linkActions:P})=>{const N=m.useMemo(()=>{const r=[];return t&&r.push(t),o&&r.push(o),r},[t,o]),R=m.useMemo(()=>[{fieldType:"input",name:"email",label:v,originalValue:S??"",type:"text",pattern:"email",onControlledChange:j,required:!0,error:F??"Ange en korrekt e-post e.g. mail@mail.com",size:"full"},{fieldType:"input",name:"password",label:w,originalValue:_??"",type:"password",pattern:"password",onControlledChange:x,required:!0,error:q??"Lösenord måste vara minst x tecken...",size:"full"}],[]);return a.jsxs("div",{className:p.loginForm,children:[a.jsx("div",{className:p.logoWrapper,children:d&&d}),a.jsx(z,{formTitle:e,formSubtitle:L,fields:R.map(r=>({...r,valid:I(r)})),loading:!!C,onControlledSubmit:T,actions:B,linkActions:P,generalErrorMessage:k,links:N,responseMessage:M,captcha:E,isLogin:!0})]})};l.__docgenInfo={description:"",methods:[],displayName:"LoginForm",props:{title:{required:!0,tsType:{name:"string"},description:""},description:{required:!1,tsType:{name:"string"},description:""},usernameLabel:{required:!0,tsType:{name:"string"},description:""},username:{required:!1,tsType:{name:"string"},description:""},passwordLabel:{required:!0,tsType:{name:"string"},description:""},password:{required:!1,tsType:{name:"string"},description:""},actions:{required:!0,tsType:{name:"Array",elements:[{name:"IButton"}],raw:"IButton[]"},description:""},linkActions:{required:!1,tsType:{name:"Array",elements:[{name:"ILinkButton"}],raw:"ILinkButton[]"},description:""},forgotPassword:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  name: string;
  href: string;
...
}`,...(b=(f=s.parameters)==null?void 0:f.docs)==null?void 0:b.source}}};const O=["LoginFormStory","LoginFormStory_Loading"],K=Object.freeze(Object.defineProperty({__proto__:null,LoginFormStory:n,LoginFormStory_Loading:s,__namedExportsOrder:O,default:G},Symbol.toStringTag,{value:"Module"}));export{n as L,s as a,l as b,K as l};
