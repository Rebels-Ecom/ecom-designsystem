import{c as r}from"./index-09749a66.js";import{j as c}from"./jsx-runtime-03333307.js";const o="_defaultStyling_1ftqk_1",t="_error_1ftqk_21",s="_success_1ftqk_29",e={defaultStyling:o,"icon-small":"_icon-small_1ftqk_11","icon-medium":"_icon-medium_1ftqk_13","icon-large":"_icon-large_1ftqk_15","icon-xlarge":"_icon-xlarge_1ftqk_17",error:t,success:s},u=({icon:i,size:n,className:a,color:l})=>c.jsx("span",{className:r("icomoon",i,a||e.defaultStyling,{[e[`icon-${n}`]]:!!n,[e[l??""]]:!!l})});u.__docgenInfo={description:"",methods:[],displayName:"Icon",props:{icon:{required:!0,tsType:{name:"union",raw:`| 'icon-alert-circle'\r
| 'icon-bell'\r
| 'icon-arrow-right'\r
| 'icon-mail'\r
| 'icon-map-pin'\r
