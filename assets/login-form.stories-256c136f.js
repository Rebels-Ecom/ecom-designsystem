import{L as I}from"./logotype-b231096a.js";import{r as m,j as a}from"./jsx-runtime-03333307.js";import{F as J,v as U}from"./form-28188d43.js";import{l as i}from"./Spendrups_logo_horizontal-038b757f.js";const A="_loginForm_cmt81_1",D="_logo_cmt81_29",G="_closeButton_cmt81_38",O="_overlay_cmt81_47",p={loginForm:A,logo:D,closeButton:G,overlay:O},l=({title:e,description:h,usernameLabel:v,username:S,passwordLabel:w,password:T,forgotPassword:t,onSubmit:_,offerLink:o,errorMessage:k,usernameError:F,passwordError:q,onPasswordChange:x,onUsernameChange:j,loading:C,logo:d,responseMessage:M,captcha:E,actions:P,linkActions:B})=>{const N=m.useMemo(()=>{const r=[];return t&&r.push(t),o&&r.push(o),r},[t,o]),z=m.useMemo(()=>[{fieldType:"input",name:"email",label:v,originalValue:S??"",type:"text",pattern:"email",onControlledChange:j,required:!0,error:F??"Ange en korrekt e-post e.g. mail@mail.com",size:"full"},{fieldType:"input",name:"password",label:w,originalValue:T??"",type:"password",pattern:"password",onControlledChange:x,required:!0,error:q??"Lösenord måste vara minst x tecken...",size:"full"}],[]);return a.jsxs("div",{className:p.loginForm,children:[d&&a.jsx(I,{...d,classNamePicture:p.logo}),a.jsx(J,{formTitle:e,formSubtitle:h,fields:z.map(r=>({...r,valid:U(r)})),loading:!!C,onControlledSubmit:_,actions:P,linkActions:B,generalErrorMessage:k,links:N,responseMessage:M,captcha:E,isLogin:!0})]})};l.__docgenInfo={description:"",methods:[],displayName:"LoginForm",props:{title:{required:!0,tsType:{name:"string"},description:""},description:{required:!1,tsType:{name:"string"},description:""},usernameLabel:{required:!0,tsType:{name:"string"},description:""},username:{required:!1,tsType:{name:"string"},description:""},passwordLabel:{required:!0,tsType:{name:"string"},description:""},password:{required:!1,tsType:{name:"string"},description:""},actions:{required:!0,tsType:{name:"Array",elements:[{name:"IButton"}],raw:"IButton[]"},description:""},linkActions:{required:!1,tsType:{name:"Array",elements:[{name:"ILinkButton"}],raw:"ILinkButton[]"},description:""},forgotPassword:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  name: string;
  href: string;
