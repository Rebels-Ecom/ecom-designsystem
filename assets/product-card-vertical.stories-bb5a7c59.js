import{P as V}from"./product-card-vertical-f2980b17.js";import{c as C}from"./format-helper-6b4b1091.js";import{a as I,d as N}from"./dummy-product-117119f6.js";import{PictureStoryBeer as f}from"./picture.stories-05fb3950.js";import{a as x}from"./jsx-runtime-76c5c2e2.js";import"./product-quantity-input-e815c7e9.js";import"./input-text-e07cfb54.js";import"./index-6f814c40.js";import"./_commonjsHelpers-042e6b4d.js";import"./index-74f03c09.js";import"./form-helper-ce65ae5e.js";import"./icon-0e1526c5.js";import"./defaultFallbackImage-b43581a6.js";import"./product-variant-list-ab83b6ba.js";import"./button-314e4000.js";import"./button.module-42bc270d.js";import"./product-variant-1409f12c.js";import"./divider-lines-71f4f756.js";import"./radio-button-14f33c2f.js";import"./picture-097a8d40.js";import"./picture-helper-86177d87.js";import"./tags-list-f8e9454d.js";import"./tag-cf40f1b7.js";import"./placeholder-be41db54.js";const v={title:"Design System/Molecules/ProductCardVertical",component:V},s={render:({...e})=>{function r(c){console.log("Showing toast with product...")}return x(V,{...e,addToCart:r})}};function y(e){return e.map(r=>({text:r.Text,shape:r.Shape?r.Shape:"pill",color:r.Class}))}function A(e,r){const c=r[0].VariantId;return r.map(t=>({productName:e,variantName:t.Name,variantId:t.VariantId,country:Array.isArray(t.ShortTexts)&&t.ShortTexts.length?t.ShortTexts[0]:"",listPricePerUnitString:t.ListPricePerUnitString,price:t.ListPricePerUnit,salesUnit:t.SalesUnit,itemNumberPerSalesUnit:t.UnitsPerBaseUnit,imageUrl:t.PrimaryImageUrl,checked:t.VariantId===c,tags:y(t.Tags),onChange:()=>{}}))}function U(e){const r=e.Variants[0];return{productId:r.VariantId,productUrl:e.ProductUrl,productName:e.DisplayName,productImageUrl:r.PrimaryImageUrl,country:Array.isArray(r.ShortTexts)&&r.ShortTexts.length?r.ShortTexts[0]:"",packaging:r.VariantFullName,priceStr:r.ListPricePerUnitString,price:r.ListPricePerUnit,salesUnit:r.SalesUnit,itemNumberPerSalesUnit:r.UnitsPerBaseUnit,tags:y(r.Tags),quantity:"1",totalPrice:C(r.ListPricePerUnit*r.UnitsPerBaseUnit),productVariantList:A(e.DisplayName,e.Variants)}}const L=U(I),T=U(N),h=f.args,o={...s,args:{product:L,productImage:h}},a={...s,args:{product:T,productImage:h}},i={...s,args:{product:T,loading:!0}};var n,d,m;o.parameters={...o.parameters,docs:{...(n=o.parameters)==null?void 0:n.docs,source:{originalSource:`{
...
//# sourceMappingURL=product-card-vertical.stories-bb5a7c59.js.map
