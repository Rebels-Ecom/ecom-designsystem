import{j as a,r as X}from"./jsx-runtime-03333307.js";import{P as Y}from"./product-quantity-input-a65dfb53.js";import{g as Z}from"./picture-helper-e0ae1ee4.js";import{c as y}from"./index-09749a66.js";import{P as ee}from"./picture-d7d6bf69.js";import{I as re}from"./icon-button-e7d024c9.js";import{L as ae}from"./loader-5c06d14e.js";import{f as ne}from"./defaultFallbackImage-b43581a6.js";import{c as te}from"./format-helper-a8a0bc10.js";import{IconButtonStory_RemoveProduct as A}from"./icon-button.stories-1a44100e.js";const ie="_cartProduct_1kpka_1",le="_whiteBackground_1kpka_13",se="_imageWrapper_1kpka_18",oe="_quantityInput_1kpka_30",ce="_contentWrapper_1kpka_52",ue="_headingWrapper_1kpka_58",de="_heading_1kpka_58",me="_textGray_1kpka_75",pe="_textPurple_1kpka_81",ge="_cardPicture_1kpka_88",Pe="_cardImage_1kpka_96",ye="_iconLink_1kpka_106",t={cartProduct:ie,whiteBackground:le,imageWrapper:se,quantityInput:oe,contentWrapper:ce,headingWrapper:ue,heading:de,textGray:me,textPurple:pe,cardPicture:ge,cardImage:Pe,iconLink:ye},f=({product:n,iconButton:e,onClickRemoveProduct:i,className:r,loading:d=!1,linkComponent:v,hidePrice:h,onClick:F,whiteBackground:R})=>{const{partNo:l,productName:b,productUrl:p,primaryImageUrl:$,country:g,packaging:P,priceStr:T,quantity:K,salesUnit:D,itemNumberPerSalesUnit:z,totalPrice:G,currencyLabel:M,unitLabel:k}=n,H=Z(l,$,"64");function Q(J){i&&i(J)}return a.jsx("div",{className:y(t.cartProduct,r||"",{[t.whiteBackground]:R}),children:d?a.jsx(ae,{visible:d,text:"Loading"}):a.jsxs(a.Fragment,{children:[a.jsx("div",{className:t.imageWrapper,children:a.jsx(ee,{...H,classNamePicture:t.cardPicture,classNameImg:`${t.cardImage}`,fallbackImageUrl:ne})}),a.jsxs("div",{className:t.contentWrapper,children:[p&&v?a.jsx(v,{to:p,href:p,className:t.headingWrapper,onClick:F,children:a.jsx("h5",{className:t.heading,children:b})}):a.jsx("h5",{className:t.heading,children:b}),a.jsx("p",{className:y(t.textPurple,"bodyS"),children:h?P:`${P?`${P}:`:""} ${T?`${T} ${M??""}/${k?k.toLowerCase():""}`:""}`}),(g!==""||l!=="")&&a.jsx("p",{className:y(t.textGray,"bodyS"),children:`${l?`Art.nr. ${l}`:""} ${g&&`- ${g}`}`}),a.jsx(Y,{className:t.quantityInput,salesUnit:D,itemNumberPerSalesUnit:z,totalPrice:G,quantity:K,quantityInputId:l,disabled:!0,disabledNoBorder:!0,hidePrice:h})]}),i&&e&&a.jsx("div",{className:t.iconLink,children:a.jsx(re,{...e,type:"button",onClick:()=>Q(l),name:"Remove product"})})]})})};f.__docgenInfo={description:"",methods:[],displayName:"CartProduct",props:{partNo:{required:!0,tsType:{name:"string"},description:""},productName:{required:!0,tsType:{name:"string"},description:""},productUrl:{required:!1,tsType:{name:"string"},description:""},primaryImageUrl:{required:!0,tsType:{name:"string"},description:""},productDescription:{required:!1,tsType:{name:"string"},description:""},country:{required:!1,tsType:{name:"string"},description:""},packaging:{required:!0,tsType:{name:"string"},description:""},price:{required:!0,tsType:{name:"number"},description:""},priceStr:{required:!0,tsType:{name:"string"},description:""},pricePerUnit:{required:!0,tsType:{name:"number"},description:""},pricePerUnitString:{required:!0,tsType:{name:"string"},description:""},packagePrice:{required:!0,tsType:{name:"number"},description:""},packagePriceString:{required:!0,tsType:{name:"string"},description:""},salesUnit:{required:!0,tsType:{name:"string"},description:""},itemNumberPerSalesUnit:{required:!0,tsType:{name:"number"},description:""},quantity:{required:!0,tsType:{name:"string"},description:""},totalPrice:{required:!0,tsType:{name:"string"},description:""},productVariantList:{required:!0,tsType:{name:"Array",elements:[{name:"IProductVariant"}],raw:"Array<IProductVariant>"},description:""},outOfStock:{required:!1,tsType:{name:"boolean"},description:""},tags:{required:!1,tsType:{name:"Array",elements:[{name:"ITag"}],raw:"Array<ITag>"},description:""},sellerOnly:{required:!1,tsType:{name:"boolean"},description:""},activeCampaign:{required:!1,tsType:{name:"signature",type:"object",raw:`{
  title: string;
  description?: string;
...
}`,...(I=(S=s.parameters)==null?void 0:S.docs)==null?void 0:I.source}}};var x,q,C;o.parameters={...o.parameters,docs:{...(x=o.parameters)==null?void 0:x.docs,source:{originalSource:`{
  ...CartProductStoryTemplate,
  args: {
...
}`,...(_=(N=c.parameters)==null?void 0:N.docs)==null?void 0:_.source}}};var V,B,w;u.parameters={...u.parameters,docs:{...(V=u.parameters)==null?void 0:V.docs,source:{originalSource:`{
  ...CartProductStoryTemplate,
  args: {
    product: productWineArgs,
    loading: false,
