import{r as _,j as i}from"./jsx-runtime-03333307.js";import{I as j}from"./icon-button-8e526a77.js";import{c as v}from"./index-09749a66.js";import{B as R}from"./button-e2072245.js";import{L}from"./loader-5c06d14e.js";import{H as P}from"./heading-ba18f9a9.js";import{C as A}from"./content-wrapper-adfa8526.js";import"./ui-link-e60391c5.js";import"./icon-cf6ebd85.js";import"./motion-9380e2c6.js";import"./tslib.es6-4d885d63.js";import"./button.module-16a60bae.js";const V="_table_1nm6j_1",H="_top_1nm6j_8",K="_heading_1nm6j_22",F="_mobile_1nm6j_30",J="_columnTitle_1nm6j_39",M="_group_1nm6j_45",Q="_icons_1nm6j_49",U="_row_1nm6j_57",X="_item_1nm6j_64",Y="_desktop_1nm6j_69",Z="_column_1nm6j_39",B="_equalWidthColumn_1nm6j_80",ee="_lastTextColumn_1nm6j_85",ne="_columnTitleText_1nm6j_109",ae="_icon_1nm6j_49",l={table:V,top:H,heading:K,mobile:F,columnTitle:J,group:M,icons:Q,row:U,item:X,desktop:Y,column:Z,equalWidthColumn:B,lastTextColumn:ee,columnTitleText:ne,icon:ae},h=({listItems:c,hideColumnTitles:f=!1,equalWidthColumns:I=!1,listGap:E=0,loading:O,initialSortBy:D,title:g,action:k})=>{const[e,y]=_.useState(),$=c==null?void 0:c.sort((n,a)=>Object.keys(a).length-Object.keys(n).length)[0],r=c.length?Object.keys($):[];_.useEffect(()=>{y({by:D??r[0],dir:"asc"})},[]);const W=(n,a)=>(e==null?void 0:e.dir)==="asc"?n[(e==null?void 0:e.by)??r[0]]===a[(e==null?void 0:e.by)??r[0]]?0:n[(e==null?void 0:e.by)??r[0]]>a[(e==null?void 0:e.by)??r[0]]?1:-1:(e==null?void 0:e.dir)==="desc"?n[(e==null?void 0:e.by)??r[0]]===a[(e==null?void 0:e.by)??r[0]]?0:n[(e==null?void 0:e.by)??r[0]]>a[(e==null?void 0:e.by)??r[0]]?-1:1:0,b=(n,a)=>i.jsx(j,{...n,size:"medium",noPadding:!0,isTransparent:!0,noBorder:!0,name:n.icon==="icon-edit"?"Edit field":"Delete field"},a),G=n=>c.sort((a,o)=>W(a,o)).map((a,o)=>typeof a[n]=="object"?i.jsx("div",{className:v(l.item,l.icon),children:b(a[n],o.toString())},`${a[n]}-${o}`):i.jsx("span",{className:l.item,children:a[n]},`${a[n]}-${o}`)),z={"--list-gap":`${E}rem`};return O?i.jsx(L,{visible:!0,size:"md"}):i.jsxs("div",{className:l.table,style:z,children:[i.jsxs("div",{className:l.top,children:[g&&i.jsx(P,{className:l.heading,order:5,children:g}),k&&i.jsx(R,{...k})]}),i.jsx("div",{className:l.mobile,children:c.map((n,a)=>{const o=Object.entries(n),s=o==null?void 0:o.filter(([t])=>!t.includes("icon")),u=o==null?void 0:o.filter(([t])=>t.includes("icon"));return i.jsxs("div",{className:l.group,children:[s!=null&&s.length?s.map(([t,m])=>i.jsxs("div",{className:l.row,children:[!f&&!t.includes("icon")?i.jsx("span",{className:l.columnTitle,children:`${t}: `}):"",i.jsx("span",{className:l.item,children:typeof m=="object"?b(m,`${t}-${a}`):m})]},`${t}-${a}`)):null,u!=null&&u.length?i.jsx("div",{className:l.icons,children:u.map(([t,m])=>typeof m=="object"&&b(m,`${t}-${a}`))}):null]},a)})}),i.jsx("div",{className:l.desktop,children:r==null?void 0:r.map((n,a)=>{const o=r==null?void 0:r.filter(s=>!s.includes("icon"));return i.jsxs("div",{className:v(l.column,{[l.equalWidthColumn]:I,[l.textColumn]:!n.includes("icon"),[l.iconColumn]:n.includes("icon"),[l.lastTextColumn]:o[(o==null?void 0:o.length)-1]===n}),children:[!f&&i.jsx("span",{className:v(l.item,l.columnTitle,{[l.icon]:n.includes("icon")}),children:!n.includes("icon")&&i.jsxs(i.Fragment,{children:[i.jsx("span",{className:l.columnTitleText,children:n}),i.jsx(j,{icon:(e==null?void 0:e.by)===n&&(e==null?void 0:e.dir)==="asc"?"icon-chevron-down":"icon-chevron-up",type:"button",onClick:()=>y({by:n,dir:(e==null?void 0:e.by)===n&&(e==null?void 0:e.dir)==="asc"?"desc":"asc"}),isTransparent:!0,noBorder:!0,name:"Sort by"})]})}),G(n)]},`${n}-${a}`)})})]})};h.__docgenInfo={description:"",methods:[],displayName:"Table",props:{listItems:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:"{ [key: string]: string | TIconButton }",signature:{properties:[{key:{name:"string"},value:{name:"union",raw:"string | TIconButton",elements:[{name:"string"},{name:"intersection",raw:`{
  type: 'link' | 'button'
  icon: TIcon
  name?: string;
...
@default undefined`},{key:"weight",value:{name:"union",raw:"'normal' | 'bold'",elements:[{name:"literal",value:"'normal'"},{name:"literal",value:"'bold'"}],required:!1}}]}},{name:"unknown"}]}],required:!0}}]}}],raw:"Array<TListItem>"},description:""},hideColumnTitles:{required:!1,tsType:{name:"boolean"},description:`If true, no column titles will be display
...
}`,...(w=(T=d.parameters)==null?void 0:T.docs)==null?void 0:w.source}}};var N,C,q;p.parameters={...p.parameters,docs:{...(N=p.parameters)==null?void 0:N.docs,source:{originalSource:`{
  ...TableStoryTemplate,
  args: ({
    listItems: [{
      animal: 'Dog',
...
}`,...(q=(C=p.parameters)==null?void 0:C.docs)==null?void 0:q.source}}};const he=["TableStory","TableStoryTwo"];export{d as TableStory,p as TableStoryTwo,he as __namedExportsOrder,ve as default};
