import{r as m,j as s}from"./jsx-runtime-03333307.js";import{F as I,v as J}from"./form-cdc89d10.js";import{l as i}from"./Spendrups_logo_horizontal-038b757f.js";const R="_loginForm_n3mi9_1",U="_logoWrapper_n3mi9_15",W="_logo_n3mi9_15",A="_closeButton_n3mi9_44",D="_overlay_n3mi9_53",p={loginForm:R,logoWrapper:U,logo:W,closeButton:A,overlay:D},l=({title:e,description:L,usernameLabel:v,username:k,passwordLabel:S,password:_,forgotPassword:o,onSubmit:w,offerLink:t,errorMessage:q,usernameError:F,passwordError:T,onPasswordChange:C,onUsernameChange:x,loading:j,logo:d,responseMessage:M,captcha:B,actions:P,linkActions:N})=>{const E=m.useMemo(()=>{const r=[];return o&&r.push(o),t&&r.push(t),r},[o,t]),z=m.useMemo(()=>[{fieldType:"input",name:"email",label:v,originalValue:k??"",type:"text",pattern:"email",onControlledChange:x,required:!0,error:F??"Ange en korrekt e-post e.g. mail@mail.com",size:"full"},{fieldType:"input",name:"password",label:S,originalValue:_??"",type:"password",pattern:"password",onControlledChange:C,required:!0,error:T??"Lösenord måste vara minst x tecken...",size:"full"}],[]);return s.jsxs("div",{className:p.loginForm,children:[s.jsx("div",{className:p.logoWrapper,children:d&&d}),s.jsx(I,{formTitle:e,formSubtitle:L,fields:z.map(r=>({...r,valid:J(r)})),loading:!!j,onSubmit:w,actions:P,linkActions:N,generalErrorMessage:q,links:E,responseMessage:M,captcha:B,isLogin:!0})]})};l.__docgenInfo={description:"",methods:[],displayName:"LoginForm",props:{title:{required:!0,tsType:{name:"string"},description:""},description:{required:!1,tsType:{name:"string"},description:""},usernameLabel:{required:!0,tsType:{name:"string"},description:""},username:{required:!1,tsType:{name:"string"},description:""},passwordLabel:{required:!0,tsType:{name:"string"},description:""},password:{required:!1,tsType:{name:"string"},description:""},actions:{required:!0,tsType:{name:"Array",elements:[{name:"IButton"}],raw:"IButton[]"},description:""},linkActions:{required:!1,tsType:{name:"Array",elements:[{name:"ILinkButton"}],raw:"ILinkButton[]"},description:""},forgotPassword:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  name: string
  href: string
