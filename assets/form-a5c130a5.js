import{r as u,j as r}from"./jsx-runtime-03333307.js";import{I as R}from"./input-field-1c6458a7.js";import{c as y}from"./index-09749a66.js";import{m as A}from"./motion-9380e2c6.js";import{I as L}from"./icon-cf6ebd85.js";import{H as k}from"./heading-ba18f9a9.js";import{T as M}from"./text-1a10703e.js";import{B as x}from"./button-8e3f9b10.js";import{F as v}from"./flex-container-7aff6506.js";import{E as N}from"./expandable-wrapper-ef692179.js";import{L as B}from"./link-button-deeb7d4c.js";const F=(n,s)=>{switch(n){case"email":return s&&H(s);case"password":return s&&V(s);case"age-verification":return s&&Number(s)>19;default:return!0}},S=n=>n.required?n.pattern?!!F(n.pattern,n.value??n.originalValue)&&!!(n.value??n.originalValue):!!(n.value??n.originalValue):n.pattern?!!F(n.pattern,n.value??n.originalValue):!0,H=n=>n&&/^[\w-\.]+@([\w-]+\.)+[\w-]{2,}$/.test(n),V=n=>n&&n!=="",W="_form_1y2wm_1",$="_formDirectionRow_1y2wm_6",z="_formTitle_1y2wm_11",U="_fieldsWrapper_1y2wm_15",P="_fieldsContainer_1y2wm_20",J="_field_1y2wm_15",O="_half_1y2wm_33",X="_full_1y2wm_37",G="_fieldDirectionRow_1y2wm_41",K="_actionsWrapper_1y2wm_47",Q="_link_1y2wm_56",Y="_linkDisabled_1y2wm_57",Z="_generalErrorMessage_1y2wm_68",ee="_generalErrorMessageDisabled_1y2wm_79",ne="_loaderContainer_1y2wm_89",re="_successIcon_1y2wm_100",t={form:W,formDirectionRow:$,formTitle:z,fieldsWrapper:U,fieldsContainer:P,field:J,half:O,full:X,fieldDirectionRow:G,actionsWrapper:K,link:Q,linkDisabled:Y,generalErrorMessage:Z,generalErrorMessageDisabled:ee,loaderContainer:ne,successIcon:re},ae=({onSubmit:n,onControlledSubmit:s,formTitle:h,formSubtitle:g,loading:d,responseMessage:c,...a})=>{var T,_;const[m,w]=u.useState(a.fields),[j,q]=u.useState(!1),b=u.useRef(null);u.useEffect(()=>{if(!b.current)return;const e=!m.some(i=>i.required&&!i.valid);q(e)},[m]);const E=u.useCallback(e=>{e.preventDefault(),n==null||n(m),s==null||s(e)},[m,n]),I=u.useCallback((e,i)=>{m.find(l=>l.name===i)&&w(l=>l.map(o=>{if(o.name===i){if(o.alphaField){const f=l.find(D=>D.name===o.alphaField);return{...o,dirty:!0,valid:(f==null?void 0:f.value)===e,value:e}}return{...o,dirty:!0,valid:S({...o,value:e}),value:e}}else return o.alphaField?{...o,dirty:o.dirty,valid:o.value===e,value:o.name===i?e:o.value}:o}))},[]),C=e=>{w(i=>i.map(l=>l.name===e?{...l,valid:!0}:l))};return c?r.jsx(A.div,{initial:{opacity:0,scale:.2},animate:{opacity:c?1:0,scale:c?1:.2},children:r.jsxs("div",{className:t.loaderContainer,children:[c.icon&&r.jsx(L,{icon:c.icon,className:t.successIcon}),c.title&&r.jsx(k,{order:3,noMargin:!0,children:c.title}),r.jsx(M,{align:"center",children:c.message}),c.onClose&&r.jsx(x,{type:"button",surface:"primary",onClick:c.onClose,children:c.closeLabel??"Stäng"})]})}):r.jsxs("form",{ref:b,className:y(t.form,a.alignSubmitButtonHorizontally?t.formDirectionRow:""),onSubmit:E,autoComplete:"on",children:[r.jsxs("div",{className:t.fieldsWrapper,children:[h&&r.jsx(k,{order:3,className:t.formTitle,children:h}),g&&r.jsx("p",{className:t.formSubtitle,children:g}),r.jsx(v,{wrap:!0,className:t.fieldsContainer,children:m==null?void 0:m.map((e,i)=>r.jsx("div",{className:y(t.field,a.alignSubmitButtonHorizontally?t.fieldDirectionRow:"",t[e.size??"half"]),children:e.fieldType==="input"&&r.jsx(R,{...e,value:e.value??e.originalValue,onChange:(p,l)=>{I(p,l)},onControlledChange:p=>{var l;(l=e.onControlledChange)==null||l.call(e,p)},focusOnRender:i===0,readonly:e.blocked,disabled:d,validateAutofill:a.isLogin?C:void 0})},e.name))}),r.jsx(N,{open:!!a.generalErrorMessage,children:r.jsx(v,{alignItems:"center",justifyContent:"center",children:a.generalErrorMessage&&r.jsx("p",{className:y(t.generalErrorMessage,{[t.generalErrorMessageDisabled]:d}),dangerouslySetInnerHTML:{__html:a.generalErrorMessage}})})})]}),a.captcha&&r.jsx(v,{justifyContent:"center",alignItems:"center",children:a.captcha}),(a.actions||a.linkActions)&&r.jsxs(v,{justifyContent:a.alignActions??"center",className:t.actionsWrapper,children:[(T=a.actions)==null?void 0:T.map((e,i)=>r.jsx(x,{...e,disabled:e.type==="submit"?!j||e.disabled:e.disabled||d,loading:e.type==="submit"&&d},`${e.type}-${i}`)),(_=a.linkActions)==null?void 0:_.map((e,i)=>r.jsx(B,{...e},`${e.id??"0"}-${i}`))]}),a.links&&r.jsx(v,{alignItems:a.alignActions??"center",flexDirection:"column",children:a.links.map((e,i)=>r.jsx("a",{className:y(t.link,{[t.linkDisabled]:d}),href:e.href,target:"_blank",children:e.name},`${e.name}-${i}`))})]})};ae.__docgenInfo={description:"",methods:[],displayName:"Form",props:{formTitle:{required:!0,tsType:{name:"string"},description:"descriptive title to display on top of form"},formSubtitle:{required:!1,tsType:{name:"string"},description:"descriptive subtitle to display under formTitle"},onSubmit:{required:!1,tsType:{name:"signature",type:"function",raw:"(data: TFormFieldType[]) => void",signature:{arguments:[{type:{name:"Array",elements:[{name:"intersection",raw:`{
